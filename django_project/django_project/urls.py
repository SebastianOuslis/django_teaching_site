...
from users.views import UserSalesListView, UserPurchasesListView, InstructorSignupPage
...
urlpatterns = [
    ...
    path('profile/sales', UserSalesListView.as_view(), name='sales'),
    path('profile/purchases', UserPurchasesListView.as_view(), name='purchases'),
    path('instructor_signup', InstructorSignupPage.as_view(template_name='users/instructor_signup.html'), name='instructor_signup'),
